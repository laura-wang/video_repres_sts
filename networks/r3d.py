...
class R3DNet(nn.Module):
    ...
    def __init__(self, layer_sizes, block_type=SpatioTemporalResBlock, motion_dims=14, app_dims=13):
...
if __name__ == '__main__':
    ...
    motion_output, app_out = r3d(input)
    print(motion_output.shape, app_out.shape)